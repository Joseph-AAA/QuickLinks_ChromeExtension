...
function App(){
  ...
  return(
    <div className="flex flex-col justify-center items-center min-h-lvh  "  style={{ backgroundImage: img ? `url(${img.urls.full})` : "none" }}>
      ...
      <main className="w-full  flex flex-col justify-center items-center mt-30  gap-7">
          <h1 className="text-center text-white drop-shadow-[0_3px_8px_rgba(0,0,0,1)]  text-3xl sm:text-4xl lg:text-5xl font-bold">
